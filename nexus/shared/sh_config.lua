...
nexus.main = {} -- Main config table

nexus.main.version = "1.0.0" -- Current Script version | Please do not change this
nexus.main.check_for_updates = true -- Check for updates on startup (true/false) | Recommend leaving it on
nexus.main.language = "EN" -- Available languages: EN, DE | More in the future

nexus.main.admins = { -- Admins table | Please add your steam hex
